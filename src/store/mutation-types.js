...
export const RECEIVE_SWIPERLIST = 'receive_swiperList'
export const RECEIVE_ICONLIST = 'receive_iconList'
export const RECEIVE_ACTIVITY_TYPES = 'receive_activity_types' // tag:delete_after
export const RECEIVE_TIME_TYPES = 'receive_time_types' // tag:delete_after
export const RECEIVE_DISTANCE_TYPES = 'receive_distance_types' // tag:delete_after
