import {
  ...
  RECEIVE_ADDRESS,
  RECEIVE_SWIPERLIST, // tag:delete_after
  RECEIVE_ICONLIST, // tag:delete_after
  RECEIVE_ACTIVITY_TYPES, // tag:delete_after
  RECEIVE_TIME_TYPES, // tag:delete_after
  RECEIVE_DISTANCE_TYPES // tag:delete_after
} from './mutation-types'

import { setStore, getStore } from '../utils/storageUtils'
...
export default {
  ...
  // tag:delete_after
  [RECEIVE_SWIPERLIST] (state, { swiperList }) {
    state.swiperList = swiperList
  },
  // tag:delete_after
  [RECEIVE_ICONLIST] (state, { iconList }) {
    state.iconList = iconList
  },
  // tag:delete_after
  [RECEIVE_ACTIVITY_TYPES] (state, { activityTypes }) {
    state.activity_types = activityTypes
  },
  // tag:delete_after
  [RECEIVE_TIME_TYPES] (state, { timeTypes }) {
    state.time_types = timeTypes
  },
  // tag:delete_after
  [RECEIVE_DISTANCE_TYPES] (state, { distanceTypes }) {
    state.distance_types = distanceTypes
  }
}
